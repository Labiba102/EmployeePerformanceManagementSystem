...
const HRManagerEvaluationForm = () => {
  const location = useLocation();
  const navigate = useNavigate();
  const [department, setDepartment] = useState("");

  // the evaluation form that the hr manager will fill for the team of project managers under him
  useEffect(() => {
...
export default HRManagerEvaluationForm;
